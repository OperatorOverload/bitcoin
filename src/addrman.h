...
public:
    ...
    //The MS visual studio preprocessor can't handle this macro, the extra parens cause compile
    //errors and if I remove the parens, the preprocesser ends up truncating the expansion
...
#else
//the following code is the output of the MSVC preprocessor and then manually edited to remove
//extra parens
